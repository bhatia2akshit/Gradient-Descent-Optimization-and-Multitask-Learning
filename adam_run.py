...
print(device)
image_data_train = torchvision.datasets.MNIST(root='./',
train=True,download=True,transform=ToTensor())
image_data_test = torchvision.datasets.MNIST(root='./',train=False,
...
def main():
    ...
    dict_stats = {'accuracy_train': train_test.train_accuracy_list,
                  'loss_train': train_test.train_loss_list,
                  'accuracy_test': train_test.test_accuracy_list,
                  'loss_test': train_test.test_loss_list}
    pickle.dump(dict_stats, open('./stats_saved.pkl','wb'))
    return dict_stats
dict_stats_adam = main()
print(dict_stats_adam.keys())